FROM fedora:30
RUN dnf -y install glibc.i686 cyrus-sasl-lib cyrus-sasl-plain libuuid openssl python gettext hostname iputils libwebsockets-devel libnghttp2-devel && dnf -y update && dnf clean all
